...
TaskQueue.prototype = {
    ...
    set runningTaskLengh(value) {
        this._runningTaskLengh = value;
    },
    get timeBeforeClose() {
...
TaskQueue.prototype.add = function(fn, taskTimeout) {
    return new BPromise((resolve, reject) => {
            ...
            _task: {
                id: taskId,
                    ...
                    if(newTask._task.alreadyDone === false && newTask._task.failed === false)
                    {
                        ...
                        else if(this._runningTaskLengh < this.parallelTask - 1){
                            this._processNext();
                        }
                    }
                },
        ...
        if(this._runningTaskLengh < this._parallelTask - 1)
        {
            this._processNext();
        }
...
TaskQueue.prototype._nextTask = function(taskId) {
